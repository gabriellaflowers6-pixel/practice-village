  ...
  <main class="member-main">
    ...
    <section class="member-section" id="rooms">
      ...
      <div class="room-grid">
        ...
        <a class="room-card" href="/studio/"><img class="room-card__img" src="/assets/rooms/moxie.jpg?v=2" alt="" loading="lazy" /><span class="room-tag room-tag--open">Open</span><b>Moxie Studios</b><span>Yoga and meditation with Moxie and the mirror. Guided practice, the meditation rooms, and the lesson library are open now. Live classes begin February 7, 2027.</span><span class="room-note">Opens here; your lobby stays one tap back.</span></a>
        <a class="room-card" href="https://curaited.org/signin?from=village" target="_blank" rel="noopener"><img class="room-card__img" src="/assets/rooms/curaited.jpg?v=2" alt="" loading="lazy" /><span class="room-tag room-tag--open">Included with membership</span><b>cur.AI.ted starter</b><span>Find the story in your camera roll. Starter access comes with your membership.</span><span class="room-note">Sign in with your Village email and your starter access is already waiting.</span><span class="room-note">Opens in a new tab so the Village stays open.</span></a>
