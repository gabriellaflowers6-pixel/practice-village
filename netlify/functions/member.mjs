  ...
  <main class="member-main">
    ...
    <section class="member-section" id="rooms">
      ...
      <div class="room-grid">
        ...
        <a class="room-card" href="https://curaited.org" target="_blank" rel="noopener"><img class="room-card__img" src="/assets/rooms/curaited.jpg?v=2" alt="" loading="lazy" /><span class="room-tag room-tag--open">Included with membership</span><b>cur.AI.ted starter</b><span>Find the story in your camera roll. Starter access comes with your membership.</span><span class="room-note">Sign in with this email. Your included access attaches as the connection completes.</span><span class="room-note">Opens in a new tab so the Village stays open.</span></a>
